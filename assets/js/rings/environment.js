...
const HARD = [
  ...
  /* And four MEDIUM ones, which exist for the step cuts. A brilliant's facets
     ...
     enough to fill a step facet and still small enough not to wash out the
     brilliants — without them the trilogy went dark while the other three
     sparkled, which is a difference of cut, not of lighting. */
  [2.2, 2.2, -1.6, 3.6, 2.3, Math.PI / 2 - 0.7, 0.5, 7, [1, 0.97, 0.93]],
  [2.6, 1.8, 2.3, 2.4, 2.7, 0.6, -0.7, 5.5, [0.9, 0.95, 1]],
  [2, 2.6, -3, 0.6, -2.2, 0, 1.3, 4.5, [1, 0.93, 0.88]],
...
const ROOMS = {
  ...
  gem: { floor: 0.09, broad: 0.3, hard: 2.6, tint: true },
};
